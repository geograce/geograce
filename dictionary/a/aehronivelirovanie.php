...
<body>
   ...
   <div class="description_general">
      ...
      <p class="txt_description_general"><strong>Аэронивелирование</strong> &ndash; способ определения высот точек
         местности с помощью радиовысотомера и статоскопа при производстве аэрофотосъемки. По показаниям радиовысотомера
         находят высоты H<sub>K</sub> (рис. 1) точек фотографирования S<sub>K</sub> над точками земной поверхности
      ...
      <p class="txt_description_general">Высоты начальной точки M<sub>1</sub> и конечной M<sub>n</sub> определяются
         ...
         Высоты характерных точек местности, необходимые для рисовки рельефа, определяются на фотограмметрических
         приборах относительно точек, полученных аэронивелированием. В горных и закрытых районах аэронивелирование не
