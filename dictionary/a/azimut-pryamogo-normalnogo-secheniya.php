...
<body>
   ...
   <div class="description_general">
      ...
      <p class="txt_description_general"><strong>Азимут прямого нормального сечения </strong> &ndash; двугранный угол,
         ...
         меридиана по ходу часовой стрелки от 0 до 360&deg;. Азимут A<sub>1,2</sub> нормального в точке 1
      ...
      <p class="txt_description_general">B<sub>1</sub>, B<sub>2</sub> и L<sub>1</sub>, L<sub>2</sub> &ndash;
         географические (геодезические) широты и долготы точек;</p>
      <p class="txt_description_general">N<sub>1</sub> и N<sub>2</sub> &ndash; радиусы кривизны первого вертикала для
         точек с широтами B<sub>1</sub> и B<sub>2</sub>;</p>
      ...
      <p class="txt_description_general">Дано: B<sub>1</sub> = 43&deg;15&prime;24.76&Prime;; B<sub>2</sub> = 63&deg;18
