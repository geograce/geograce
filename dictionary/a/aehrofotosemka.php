...
<body>
   ...
   <div class="description_general">
      ...
      <br>
      <p class="list_description_general">&bull; отсутствие специальных фотолабораторий, где происходила фотохимическая
         обработка снимков;</p>
      <p class="list_description_general">&bull; отсутствие сканирования аэрофотоснимков, т.к. снимки уже в цифровом
         виде;</p>
      <p class="list_description_general">&bull; нет геометрических искажений аэрофотоснимков, т.к. отсутствует
         деформация фотоприемника (матрица);</p>
      <p class="list_description_general">&bull; при фотограмметрической обработке отсутствует необходимость
