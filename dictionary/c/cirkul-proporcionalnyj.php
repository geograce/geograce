...
<body>
   ...
   <div class="description_general">
      <h1 class="h1_description_general">Циркуль пропорциональный</h1>
      <p class="txt_description_general"><strong>Циркуль пропорциональный</strong> &ndash; чертежный инструмент для
