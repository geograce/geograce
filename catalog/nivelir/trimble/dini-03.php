...
<head>
   ...
   <meta name="description"
      content="Использование нивелира Trimble DiNi 03 без инструкции нецелесообразно. В инструкции можно узнать, как проводить различные измерения и автоматизировать процесс. Скачать инструкцию и руководство пользователя к нивелиру Trimble DiNi 03">
   ...
   <title>Скачать инструкцию, руководство пользователя к нивелиру Trimble DiNi 03</title>
</head>
...
<body>
   ...
   <div class="instrument_takheometr">
      <h1 class="h1_instrument_takheometr">Инструкция нивелира Trimble DiNi 03</h1>
      ...
      <div class="data_table_download_instruction">
         <p class="length_name_download_instruction">Инструкция Trimble DiNi 03</p>
      ...
      <div class="data_table_download_instruction" style="border-bottom: 1px solid black;">
         <p class="length_name_download_instruction">Брошюра Trimble DiNi 03</p>
         <p class="length_type_download_instruction">pdf</p>
