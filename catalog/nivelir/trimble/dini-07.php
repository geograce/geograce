...
<head>
   ...
   <meta name="description"
      content="Использование в работе нивелира Trimble DiNi 07 без инструкции нецелесообразно. В инструкции можно узнать, как проводить различные измерения и автоматизировать процесс. Скачать инструкцию и руководство пользователя к нивелиру Trimble DiNi 07">
   ...
   <title>Скачать инструкцию, руководство пользователя к нивелиру Trimble DiNi 07</title>
</head>
...
<body>
   ...
   <div class="instrument_takheometr">
      <h1 class="h1_instrument_takheometr">Инструкция нивелира Trimble DiNi 07</h1>
      ...
      <div class="data_table_download_instruction">
         <p class="length_name_download_instruction">Инструкция Trimble DiNi 07</p>
         <p class="length_type_download_instruction">pdf</p>
         <p class="length_size_download_instruction">1.95 мб</p>
         <a href="/download/catalog/nivelir/trimble/dini-03-07/dini-03-07-instruction.pdf" target="_blank"
      ...
      <div class="data_table_download_instruction" style="border-bottom: 1px solid black;">
         <p class="length_name_download_instruction">Брошюра Trimble DiNi 07</p>
         <p class="length_type_download_instruction">pdf</p>
         <p class="length_size_download_instruction">0.16 мб</p>
         <a href="/download/catalog/nivelir/trimble/dini-03-07/dini-03-07-brochure.pdf" target="_blank"
            class="length_download_download_instruction">Скачать</a>
      </div>
      <p class="txt_instruction_instrument">Цифровой нивелир Trimble DiNi 07 &ndash; с успехом может применяться при точном
         ...
         нужно ознакомиться с инструкцией, которую можно <strong>скачать</strong> на нашем сайте. <strong>Инструкция к
            нивелиру Trimble DiNi 07</strong> очень важна для ознакомления перед первым использованием прибора, поэтому
         скачайте <strong>руководство пользователя</strong> для нивелира Trimble DiNi 07, которое вы можете распечатать
      ...
      <div class="box_img_instruction_instrument">
         ...
         <div class="img_nivelir_dini_07_1 img_item_instrument_grid_2"></div>
         <div class="img_nivelir_dini_07_2 img_item_instrument_grid_3"></div>
         <div class="img_nivelir_dini_07_3 img_item_instrument_grid_4"></div>
         <div class="img_nivelir_dini_07_4 img_item_instrument_grid_5"></div>
      </div>
   </div>
