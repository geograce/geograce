...
<head>
   ...
   <meta name="description"
      content="Использование нивелира Geomax ZAL120 без инструкции нецелесообразно. В инструкции можно узнать, как проводить различные измерения и автоматизировать процесс. Скачать инструкцию и руководство пользователя к нивелиру Geomax ZAL120">
   ...
   <title>Скачать инструкцию, руководство пользователя к нивелиру Geomax ZAL120</title>
</head>
...
<body>
   ...
   <div class="instrument_takheometr">
      <h1 class="h1_instrument_takheometr">Инструкция нивелира Geomax ZAL120</h1>
      ...
      <div class="data_table_download_instruction">
         <p class="length_name_download_instruction">Инструкция Geomax ZAL120</p>
      ...
      <div class="data_table_download_instruction" style="border-bottom: 1px solid black;">
         <p class="length_name_download_instruction">Брошюра Geomax ZAL120</p>
         <p class="length_type_download_instruction">pdf</p>
      ...
      <p class="txt_instruction_instrument">Оптический нивелир Geomax ZAL120 — это современный геодезический прибор, на
         котором установлена высококачественная просветленная оптика, а простая и надежная конструкция компенсатора
         обеспечивает надежную работу нивелира в условиях строительной площадки. При эксплуатации нивелира GeoMax нужно
         ознакомиться с инструкцией, которую можно <strong>скачать</strong> на нашем сайте. <strong>Инструкция к
            нивелиру Geomax ZAL120</strong> очень важна для ознакомления перед первым использованием прибора, поэтому
