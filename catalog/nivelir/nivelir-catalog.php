...
<head>
   ...
   <meta name="description" content="Инструкции скачать для нивелиров GeoMax, Leica, Nicon, Sokkia, Topcon, Trimble">
   <link rel="stylesheet" href="/css/style.css">
   <link rel="stylesheet" href="/css/media.css">
   <link rel="icon" href="/img/general/favicon.png">
   <link href="https://fonts.googleapis.com/css?family=Ubuntu:300,700&display=swap" rel="stylesheet">
   <link href="https://fonts.googleapis.com/css?family=IBM+Plex+Sans:300,400,700&display=swap" rel="stylesheet">
   <title>Скачать инструкции для нивелиров</title>
</head>
...
<body>
   ...
   <div class="catalog_nivelir">
      <h1 class="h1_catalog_nivelir">Инструкции нивелиров</h1>
