...
<head>
   ...
   <meta name="description"
      content="Использование тахеометра Trimble C3 5 без инструкции нецелесообразно. В инструкции можно узнать, как проводить различные измерения и автоматизировать процесс. Скачать инструкцию и руководство пользователя к тахеометру Trimble C3 5">
   ...
   <title>Скачать инструкцию, руководство пользователя к тахеометру Trimble C3 5</title>
</head>
...
<body>
   ...
   <div class="instrument_takheometr">
      <h1 class="h1_instrument_takheometr">Инструкция тахеометра Trimble C3 5&Prime;</h1>
      ...
      <div class="data_table_download_instruction">
         <p class="length_name_download_instruction">Инструкция Trimble C3 5&Prime;</p>
      ...
      <div class="data_table_download_instruction" style="border-bottom: 1px solid black;">
         <p class="length_name_download_instruction">Брошюра Trimble C3 5&Prime;</p>
         <p class="length_type_download_instruction">pdf</p>
      ...
      <p class="txt_instruction_instrument">Тахеометр Trimble C3 5&Prime; это технический тахеометр способный
         ...
         <strong>Инструкция к тахеометру Trimble C3</strong> очень важна для ознакомления перед первым
